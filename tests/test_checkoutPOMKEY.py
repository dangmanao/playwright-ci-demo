...
from keywords.checkoutinfo_keyword import CheckoutInfoKeywords
import re
...
def test_example(page: Page, logger) -> None:
    ...
    kw.click_continue_button()
    kw.should_see_error_message("Error: First Name is required")
    kw.input_firstname("Dang")
    kw.click_continue_button()
    kw.should_see_error_message("Error: Last Name is required")
    kw.input_lastname("Dang")
    kw.click_continue_button()
    kw.should_see_error_message("Error: Postal Code is required")
    kw.input_zipcode("99999")
    kw.click_continue_button()
